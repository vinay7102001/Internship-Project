...
const Form = () => {
  return (
    <>
      <form className='h-[100%] flex flex-col md:items-center xl:items-start ml-4 items-start '>
        ...
        <div className='flex w-[25vw] text-[1.1rem] mb-4 border-[1px] border-gray-400 rounded-md py-2 pl-2'>
          <input className='basis-[100%]  placeholder:text-gray-700 focus:outline-none' type='text' placeholder='Name' />
        </div>
        <label className='mt-2 mb-2 text-[14px] font-semibold'>Email</label>
        <input className='w-[25vw] text-[1.1rem] mb-2 border-[1px] border-gray-400 rounded-md py-2 pl-2 placeholder:text-gray-00 focus:outline-none' type='email' placeholder='E-mail' />

        <button className='mb-6 border-2 border-blue-500 text-[14px] text-blue-500 px-3 py-1 items-center rounded-full'>Add Guests</button>
        ...
        <label className='text-[14px] mb-3 mt-4 font-semibold w-[24vw]' for='extra_info'>Please,share anything that will helps preparing for our meeting</label>
        <textarea name='extra_info' className='border-2 border-gray-400 mb-3 rounded-md' rows='3' cols='39'></textarea>


        <label className='text-[14px] mb-3 font-semibold w-[25vw]' for='workspace_info'>Please,share with us the name of your Fibery workspace(if any)</label>
        <textarea name='workspace_info' className='border-2 border-gray-400 mb-3 rounded-md' rows='2' cols='39'></textarea>

        <button className='mb-6 bg-blue-500 text-[15px] text-white px-4 py-2 items-center rounded-full' >Schedule Event</button>
